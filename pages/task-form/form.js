...
export default function LicForm(){
        ...
        const options = 
            [   { value: "LICENCIATURA SABATINO-QUIMICA", text: "LICENCIATURA SABATINO-QUIMICA" },
                { value: "LICENCIATURA SABATINO-MECATRONICA", text: "LICENCIATURA SABATINO-MECATRONICA" },
                { value: "MAESTRIA MIM", text: "MAESTRIA MIM" },
                { value: "MAESTRIA MSH COATZA", text:"MAESTRIA MSH COATZA" },
                { value: "MAESTRIA MSH-MIMC PUEBLA", text: "MAESTRIA MSH-MIMC PUEBLA" } ]
